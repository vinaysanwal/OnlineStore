...
<div class="container">
        ...
        <div class="col-md-6 col-md-offset-3">
              ...
              if(isset($_POST['update_profile'])){
                ...
                //$raw_files = $_FILES['file']['size'];
                //$raw_files = $_FILES['file']['type'];
                ...
                if(!in_array($file_ext,$allowed_files)){
                  ...
                  <strong>Hey! </strong>Filetype is not allowed</div>');
                }else{
                 ...
                 //change the file name to the lower cases..
                   ...
                   if(move_uploaded_file($temp_folder , $folder.$cl_file))
                  {
                        ...
                        if($run){
                          ...
                          <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                          <strong>Yoo </strong>Update Successful</div>');
                        }else {
                          redirect('updateprofile.php');

                          set_msg('<div class="alert alert-danger text-center">
                          <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                          <strong>noo!!</strong>Update Fail</div>');
                        }
                  }
