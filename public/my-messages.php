            ...
            <div class="col-md-8 col-sm-12">
               ...
               <div class="text-center" style="padding: 5px; background-color: white; border: 1px solid #ddd;"><h3>Your Messages </h3>
                 ...
                 <?php
                     ...
                     $result_msg = $db->fetchMultiple();
                 ?>

                <?php foreach($result_msg as $msg){ ?>
                    ...
                    <div class="modal-dialog">
                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                           <span>Message Bod</span>
                           <div class="well well-sm"><?php echo $msg['msg'] ?></div>

                           <?php
                           $client_email = $_SESSION['user_data']['email'];
                           $reply_id = $msg['id'];
                           $db->query('SELECT * FROM msgs WHERE client_email = :email AND reply_id= :reply_id');
                           $db->bind(':email', $client_email, PDO::PARAM_STR);
                           $db->bind(':reply_id', $reply_id, PDO::PARAM_INT);

                           $reply_msg = $db->fetchMultiple();
                         ...
                         <? } ?>
                           <form class="form-group" action="" method="POST">
                              <div class="form-group">
                                ...
                                <textarea  name="reply_msg" id="" class="form-control" rows="5" required></textarea>
                              </div>
                              <div>
